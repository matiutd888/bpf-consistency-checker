...
function send {
rsync $1 --exclude "*.o.d" --exclude "linux-6.2.1/scripts/*" --exclude "linux-6.2.1/.vmlinux.objs" --exclude "*.o" --exclude "*.so.1" --exclude "*.so" --exclude "*.S" --exclude "*.dts" -rvuhP z2-tst-public zso-root:zso-2/
echo "test synced"
